      ...
      (fact "banks can submit offers per credit application (one per bank)"
        (let [created (credit-application/create!
                         ...
                         {:name "Jane Doe"
                          ...
                          :yearsExperience 5
                          :industry "Software"})
              _ (user/create! conn "bank2" "bank2Pass" "bank")
              ...
              offers (:offers item)
              bank-offer (first (filter #(= (:bank %) "bank") offers))
              bank2-offer (first (filter #(= (:bank %) "bank2") offers))
              bank-view (credit-application/list-by-bank conn "bank" {:page 1 :pageSize 50})
